...
'''
    Dieses Paket dient einzig der Animation des stick guys.
    Hier sind keine Aufgaben zu bearbeiten.
'''
...
def animate(keytime, keyframe, interpolate):
    ...
    anim = animation.FuncAnimation(fig, anim, frames=200, interval=10, blit=False)
    plt.subplots_adjust(left=0.04, right=0.98, top=0.98, bottom=0.05)
    plt.show()

    # erzeugt den abzugebenden Plot.
    plt.subplot(2,1,1)
